...
# from utils.content_utils import get_full_content_text
...
#                     content = Content.from_dict(message)
...
#         new_session["update_time"] = datetime.now().isoformat()
#         new_session['messages'] = [message.to_dict() for message in session['messages']]
...
#             messages = [{"type": message.role, "content": get_full_content_text(message)} for message in messages]
#             messages.append(
#                 {
#                     "type": "human",
